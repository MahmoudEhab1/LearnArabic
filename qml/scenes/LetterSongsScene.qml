...
SceneBase {
    ...
    Text {
        ...
        text: qsTr("اضغط على الحرف لسماع الاغنية")
        color: "red"
        font.pixelSize: 20
    }
    ...
    MenuButton {
        ...
        onClicked: {alf.stop();baa.stop();taa.stop();thaa.stop();geem.stop();hhaa.stop();
            khaa.stop();dal.stop();zal.stop();raa.stop();zay.stop();seen.stop();sheen.stop();
            ssad.stop();ddad.stop();ttaa.stop();zaa.stop();ain.stop();gheen.stop();faa.stop();
            kaf.stop();kkaf.stop();lam.stop();meem.stop();non.stop();haa.stop();waw.stop();
            yaa.stop()
